class OrdersData {
  ...
  factory OrdersData.fromJson(Map<String, dynamic> parsedJson) {
    return new OrdersData(
      orderData: parsedJson['orderData'] != null
          ? new OrderData.fromJson(parsedJson['orderData'])
          : null,
    );
  }
  ...
  factory OrderData.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return new OrderData(
      ...
      oUserAddress: parsedJson['oUserAddress'] != null
          ...
          : null,
      oProducts: parsedJson['oProducts'] != null ? productList : null,
    );
  }
