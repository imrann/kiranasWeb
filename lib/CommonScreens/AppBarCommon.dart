...
class _AppBarCommonState extends State<AppBarCommon> {
  ...
  Widget getIcon(IconData icon, BuildContext context, Widget route,
      Widget notificationCount) {
    final IconData clearAllCartIcon = Icons.clear_all_outlined;
            ...
            InkWell(
              ...
              onTap: () {
                if (icon == Icons.search) {
                  ...
                  //     context,
                  //     SlideRightRoute(
                  //         widget: Cart(), slideAction: "horizontal"));
                }
  ...
  Widget getCartNotificationBadge() {
    return new Stack(
      children: <Widget>[
        new Icon(
        ...
        new Positioned(
          ...
          child: new Container(
              ...
              child: Consumer<CartState>(builder: (context, data, child) {
                return Text(
